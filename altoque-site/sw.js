const CACHE='altoque-v3-20260804-wall';
const CORE=['./','./index.html','./manifest.json','./icon.svg','./styles.css','./wall-ads.css','./app.js','./app-core.js','./app-features.js','./wall-ads.js','./app-init.js'];
